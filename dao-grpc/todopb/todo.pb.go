...
type Todo struct {
	...
	Children    *Todo  `protobuf:"bytes,5,opt,name=children" json:"children,omitempty"`
}
...
func (m *Todo) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Children != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintTodo(dAtA, i, uint64(m.Children.Size()))
		n1, err := m.Children.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
...
func (this *Todo) String() string {
	...
	s := strings.Join([]string{`&Todo{`,
		...
		`Children:` + strings.Replace(fmt.Sprintf("%v", this.Children), "Todo", "Todo", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorTodo = []byte{
	...
	,
}
